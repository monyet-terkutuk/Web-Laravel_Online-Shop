                ...
                <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div class="col-md-6">
                    <div class="form-group"> 
                      ...
                      <input type="text" class="form-control" id="name" name="name" value="Yang Yang Muhammad Alvian">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group"> 
                      ...
                      <input type="email" class="form-control" id="email" name="email" value="your@email">
                    </div>
                  </div>
